...
import errors, { ExchangeError, AuthenticationError, ArgumentsRequired, BadRequest, PermissionDenied, RateLimitExceeded } from './base/errors.js';
import { TICK_SIZE } from './base/functions/number.js';

// ----------------------------------------------------------------------------

export default class fairdesk extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'exceptions': {
                'exact': {
                    "1000" : errors.AccountNotEnabled,                        // no such account.
                    "1002" : errors.InsufficientFunds,     // account settled currency do not match.
                    "1004" : errors.BadRequest,                     // leverage is too small
                    "1005" : errors.BadRequest,                     // leverage is too large.
                    "1006" : errors.BadRequest,                 // leverage is equal old leverage.
                    "1007" : errors.InsufficientFunds,                      // margin not enough.
                    "1008" : errors.InsufficientFunds,                   // balance insufficient.
                    "1009" : errors.BadRequest,                // the amount of recharge is illegal.
                    "1010" : errors.BaseError,          // the amount of balance change is illegal.
                    "1011" : errors.BaseError,           // invalid margin change amount.
                    "1012" : errors.ExchangeError, // leverage reduction is not supported in Isolated Margin Mode with open positions.
                    "1013" : errors.ExchangeError,              // balance version not equal.
                    "2000" : errors.ExchangeError,                      // invalid symbol id.
                    "2004" : errors.ExchangeError,                  // duplicated asset name
                    "2005" : errors.ExchangeError,                    // duplicated asset id
                    "2006" : errors.ExchangeError,                       // invalid asset id.
                    "4000" : errors.InvalidOrder,                          // no such order.
                    "4001" : errors.ArgumentsRequired,                          // price is missing.
                    "4002" : errors.ArgumentsRequired,                            // qty is missing.
                    "4003" : errors.ArgumentsRequired,                            // qty is invalid.
                    "4004" : errors.ArgumentsRequired,                    // invalid currency id.
                    "4005" : errors.OrderNotFillable,                         // unable to fill.
                    "4006" : errors.OrderImmediatelyFillable,        // order would immediately trigger.
                    "4007" : errors.ExchangeError,                     // reduce only reject.
                    "4008" : errors.BadRequest,                // position is not sufficient.
                    "4009" : errors.BadRequest,                  // reduce only rejected, position more than 0 while buy.
                    "4010" : errors.BadRequest,                 // reduce only rejected, position less than 0 while sell.
                    "4011" : errors.BadRequest,                   // max open order limit.
                    "4012" : errors.BadRequest,            // max conditional order limit.
                    "4013" : errors.BadRequest,              // conditional order is invalid.
                    "4014" : errors.DuplicateOrderId,                   // clientOrderId duplicated.
                    "4015" : errors.NotSupported,                    // reduce only reject, order type not supported.
                    "4020" : errors.CancelPending,                        // unknown order sent.
                    "4021" : errors.BadRequest,                    // unknown update type.
                    "4030" : errors.OrderNotFound,        // reduceOnly order Failed. please check your existing position and open orders.
                    "4040" : errors.OrderNotFound,                  // unable to parse order.
                    "4050" : errors.InvalidOrder,                    // the counter party's best price does not meet the PERCENT_PRICE filter limit.
                    "4051" : errors.BadRequest,               // order price not in the proper range.
                    "4060" : errors.BadRequest,                  // trigger price is missing.
                    "4070" : errors.OrderNotFound,                          // no open orders to close
                    "4071" : errors.DuplicateOrderId,                     // order id duplicated.
                    "5000" : errors.BadRequest,                  // positionSide is not valid.
                    "5001" : errors.BadRequest,                // positionSide does not match with userSetting.
                    "5002" : errors.BadRequest, // isolated position quantity should more than 0 when add margin.
                    "5003" : errors.InsufficientFunds,              // No balance for add position margin.
                    "5004" : errors.BadRequest,       // Position margin can not decrease.
                    "100" :  errors.RequestTimeout,                                // Request time out.
                    "200" :  errors.BadRequest,                   // Price less than 0.
                    "201" :  errors.BadRequest,              // Price less than min price.
                    "202" :  errors.BadRequest,           // Price greater than max price.
                    "203" :  errors.BadRequest,       // Price not increased by tick size.
                    "204" :  errors.BadRequest,                     // Quantity less than zero.
                    "205" :  errors.BadRequest,               // Quantity greater than max quantity.
                    "206" :  errors.BadRequest,                  // Quantity less than min quantity.
                    "207" :  errors.BadRequest,         // Qty not increased by step size.
                    "208" :  errors.BadRequest,           // Trigger price less than zero.
                    "209" :  errors.BadRequest,   // Trigger price greater than max price.
                    "210" :  errors.BadRequest,  // Price trigger type is null or illegal.
                    "211" :  errors.BadRequest,                 // not support order type.
                    "212" :  errors.BadRequest,                  // client order length is not valid.
                    "213" :  errors.BadRequest,                      // client order id is not valid.
                    "214" :  errors.BadRequest,                // Illegal characters found in a parameter.
                    "216" :  errors.BadRequest,     // Mandatory parameter {%s} was not sent, was empty/null, or malformed.
                    "217" :  errors.BadRequest,                     // Parameter '%s' not required.
                    "218" :  errors.BadRequest,                           // Invalid side.
                    "219" :  errors.BadRequest,              // Combination of optional parameters '%s' invalid.
                    "220" :  errors.BadRequest,                    // price range not valid
                    "221" :  errors.BadRequest,                          // Qty too large.
                    "250" :  errors.BadRequest,                       // invalid currency.
                    "300" :  errors.BadRequest,                         // invalid symbol.
                    "301" :  errors.ExchangeError,                 // symbol can not trading now.
                    "302" :  errors.ExchangeError,            // symbol order can not cancel now.
                    "400" :  errors.AccountNotEnabled,                        // invalid account.
                    "401" :  errors.AccountNotEnabled,                  // account could not trade.
                    "402" :  errors.BadRequest,                       // invalid leverage.
                    "403" :  errors.BadRequest,                        // invalid user id.
                    "405" :  errors.BadRequest,               // invalid withdraw balance.
                    "408" :  errors.InsufficientFunds,              // account margin not enough.
                    "501" :  errors.InsufficientFunds             // wallet insufficient balance
                },
                'broad': {
