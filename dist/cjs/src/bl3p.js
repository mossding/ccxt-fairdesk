...
class bl3p extends Exchange["default"] {
    ...
    parseBidAsk(bidask, priceKey = 0, amountKey = 1) {
        ...
        return [
            this.parseNumber(Precise["default"].stringDiv(price, '100000.0')),
            this.parseNumber(Precise["default"].stringDiv(size, '100000000.0')),
        ];
    }
    ...
    parseTrade(trade, market = undefined) {
        ...
        return this.safeTrade({
            ...
            'price': Precise["default"].stringDiv(price, '100000'),
            'amount': Precise["default"].stringDiv(amount, '100000000'),
            'cost': undefined,
            'fee': undefined,
        }, market);
    }
    ...
    async fetchTradingFees(params = {}) {
        ...
        const fee = this.parseNumber(Precise["default"].stringDiv(feeString, '100'));
        const result = {};
    ...
    async createOrder(symbol, type, side, amount, price = undefined, params = {}) {
        ...
        const order = {
            'market': market['id'],
            'amount_int': parseInt(Precise["default"].stringMul(amountString, '100000000')),
            'fee_currency': market['quote'],
            'type': (side === 'buy') ? 'bid' : 'ask',
        };
        if (type === 'limit') {
            order['price_int'] = parseInt(Precise["default"].stringMul(priceString, '100000.0'));
        }
