...
class fairdesk extends Exchange["default"] {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'exceptions': {
                'exact': {
                    "1000" : errors["default"].AccountNotEnabled,                        // no such account.
                    "1002" : errors["default"].InsufficientFunds,     // account settled currency do not match.
                    "1004" : errors["default"].BadRequest,                     // leverage is too small
                    "1005" : errors["default"].BadRequest,                     // leverage is too large.
                    "1006" : errors["default"].BadRequest,                 // leverage is equal old leverage.
                    "1007" : errors["default"].InsufficientFunds,                      // margin not enough.
                    "1008" : errors["default"].InsufficientFunds,                   // balance insufficient.
                    "1009" : errors["default"].BadRequest,                // the amount of recharge is illegal.
                    "1010" : errors["default"].BaseError,          // the amount of balance change is illegal.
                    "1011" : errors["default"].BaseError,           // invalid margin change amount.
                    "1012" : errors["default"].ExchangeError, // leverage reduction is not supported in Isolated Margin Mode with open positions.
                    "1013" : errors["default"].ExchangeError,              // balance version not equal.
                    "2000" : errors["default"].ExchangeError,                      // invalid symbol id.
                    "2004" : errors["default"].ExchangeError,                  // duplicated asset name
                    "2005" : errors["default"].ExchangeError,                    // duplicated asset id
                    "2006" : errors["default"].ExchangeError,                       // invalid asset id.
                    "4000" : errors["default"].InvalidOrder,                          // no such order.
                    "4001" : errors["default"].ArgumentsRequired,                          // price is missing.
                    "4002" : errors["default"].ArgumentsRequired,                            // qty is missing.
                    "4003" : errors["default"].ArgumentsRequired,                            // qty is invalid.
                    "4004" : errors["default"].ArgumentsRequired,                    // invalid currency id.
                    "4005" : errors["default"].OrderNotFillable,                         // unable to fill.
                    "4006" : errors["default"].OrderImmediatelyFillable,        // order would immediately trigger.
                    "4007" : errors["default"].ExchangeError,                     // reduce only reject.
                    "4008" : errors["default"].BadRequest,                // position is not sufficient.
                    "4009" : errors["default"].BadRequest,                  // reduce only rejected, position more than 0 while buy.
                    "4010" : errors["default"].BadRequest,                 // reduce only rejected, position less than 0 while sell.
                    "4011" : errors["default"].BadRequest,                   // max open order limit.
                    "4012" : errors["default"].BadRequest,            // max conditional order limit.
                    "4013" : errors["default"].BadRequest,              // conditional order is invalid.
                    "4014" : errors["default"].DuplicateOrderId,                   // clientOrderId duplicated.
                    "4015" : errors["default"].NotSupported,                    // reduce only reject, order type not supported.
                    "4020" : errors["default"].CancelPending,                        // unknown order sent.
                    "4021" : errors["default"].BadRequest,                    // unknown update type.
                    "4030" : errors["default"].OrderNotFound,        // reduceOnly order Failed. please check your existing position and open orders.
                    "4040" : errors["default"].OrderNotFound,                  // unable to parse order.
                    "4050" : errors["default"].InvalidOrder,                    // the counter party's best price does not meet the PERCENT_PRICE filter limit.
                    "4051" : errors["default"].BadRequest,               // order price not in the proper range.
                    "4060" : errors["default"].BadRequest,                  // trigger price is missing.
                    "4070" : errors["default"].OrderNotFound,                          // no open orders to close
                    "4071" : errors["default"].DuplicateOrderId,                     // order id duplicated.
                    "5000" : errors["default"].BadRequest,                  // positionSide is not valid.
                    "5001" : errors["default"].BadRequest,                // positionSide does not match with userSetting.
                    "5002" : errors["default"].BadRequest, // isolated position quantity should more than 0 when add margin.
                    "5003" : errors["default"].InsufficientFunds,              // No balance for add position margin.
                    "5004" : errors["default"].BadRequest,       // Position margin can not decrease.
                    "100" :  errors["default"].RequestTimeout,                                // Request time out.
                    "200" :  errors["default"].BadRequest,                   // Price less than 0.
                    "201" :  errors["default"].BadRequest,              // Price less than min price.
                    "202" :  errors["default"].BadRequest,           // Price greater than max price.
                    "203" :  errors["default"].BadRequest,       // Price not increased by tick size.
                    "204" :  errors["default"].BadRequest,                     // Quantity less than zero.
                    "205" :  errors["default"].BadRequest,               // Quantity greater than max quantity.
                    "206" :  errors["default"].BadRequest,                  // Quantity less than min quantity.
                    "207" :  errors["default"].BadRequest,         // Qty not increased by step size.
                    "208" :  errors["default"].BadRequest,           // Trigger price less than zero.
                    "209" :  errors["default"].BadRequest,   // Trigger price greater than max price.
                    "210" :  errors["default"].BadRequest,  // Price trigger type is null or illegal.
                    "211" :  errors["default"].BadRequest,                 // not support order type.
                    "212" :  errors["default"].BadRequest,                  // client order length is not valid.
                    "213" :  errors["default"].BadRequest,                      // client order id is not valid.
                    "214" :  errors["default"].BadRequest,                // Illegal characters found in a parameter.
                    "216" :  errors["default"].BadRequest,     // Mandatory parameter {%s} was not sent, was empty/null, or malformed.
                    "217" :  errors["default"].BadRequest,                     // Parameter '%s' not required.
                    "218" :  errors["default"].BadRequest,                           // Invalid side.
                    "219" :  errors["default"].BadRequest,              // Combination of optional parameters '%s' invalid.
                    "220" :  errors["default"].BadRequest,                    // price range not valid
                    "221" :  errors["default"].BadRequest,                          // Qty too large.
                    "250" :  errors["default"].BadRequest,                       // invalid currency.
                    "300" :  errors["default"].BadRequest,                         // invalid symbol.
                    "301" :  errors["default"].ExchangeError,                 // symbol can not trading now.
                    "302" :  errors["default"].ExchangeError,            // symbol order can not cancel now.
                    "400" :  errors["default"].AccountNotEnabled,                        // invalid account.
                    "401" :  errors["default"].AccountNotEnabled,                  // account could not trade.
                    "402" :  errors["default"].BadRequest,                       // invalid leverage.
                    "403" :  errors["default"].BadRequest,                        // invalid user id.
                    "405" :  errors["default"].BadRequest,               // invalid withdraw balance.
                    "408" :  errors["default"].InsufficientFunds,              // account margin not enough.
                    "501" :  errors["default"].InsufficientFunds             // wallet insufficient balance
                },
                'broad': {
